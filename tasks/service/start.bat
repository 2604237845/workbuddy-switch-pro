...
rem Keep the window open on any non-zero exit code so the message can be read.
rem launch.py exit codes: 1=not running 3=port busy 4=failed 5=start timeout
